...
/**
 * The primary key class for the uno_i_nota_tags database table.
 * 
 */
@Embeddable
public class INotaTagPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof INotaTagPK)) {
			return false;
		}
		INotaTagPK castOther = (INotaTagPK)other;
		return 
